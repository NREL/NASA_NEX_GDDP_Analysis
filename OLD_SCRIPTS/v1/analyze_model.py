...
def analyze_model(input_model, thresholds_dict):
    # Year to 
    comparison_year_1 = 2020
    ...
    ### Getting items a2, a9, and a10: Decade average daily temperature range, windspeed, and maximum windspeed
