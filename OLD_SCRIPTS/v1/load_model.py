...
class load_model:
    def __init__(self, path, model_name, experiment_name):
        ...
        date_time_span = pd.date_range(start = '2010-01-01 12:00:00', end = self.max_year+'-12-31 12:00:00', freq = 'y')
        self.df_annual = pd.DataFrame(np.nan, columns = self.variables_to_compile, index = date_time_span)

        col = self.decade_variables
        date_time_span = pd.date_range(start = '2010-01-01 12:00:00', end = self.max_year+'-12-31 12:00:00', freq = '10y')
